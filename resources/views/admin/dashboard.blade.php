...
<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
    @php
        $cards = [
            ...
            ['label' => 'Students', 'value' => $stats['students'], 'icon' => '🎓', 'color' => 'bg-cyan-500'],
            ['label' => 'Results', 'value' => $stats['results'], 'icon' => '📊', 'color' => 'bg-indigo-500'],
            ['label' => 'Routine Entries', 'value' => $stats['routines'], 'icon' => '🗓️', 'color' => 'bg-teal-500'],
