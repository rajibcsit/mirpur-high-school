...
@section('title','Add Routine') @section('page-title','Add Routine Entry')
@section('content')<div class="max-w-4xl bg-white rounded-xl shadow p-6"><form method="POST" action="{{ route('admin.routines.store') }}">@csrf
...
<div class="mt-6"><button class="bg-primary text-white px-6 py-2 rounded-lg">Save Routine</button></div></form></div>@endsection
