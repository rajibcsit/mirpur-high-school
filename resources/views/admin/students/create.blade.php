...
@section('title','Add Student') @section('page-title','Add Student')
@section('content')<div class="max-w-4xl bg-white rounded-xl shadow p-6"><form method="POST" action="{{ route('admin.students.store') }}" enctype="multipart/form-data">@csrf
...
<div class="mt-6"><button class="bg-primary text-white px-6 py-2 rounded-lg">Save Student</button></div></form></div>@endsection
