...
@section('title','Edit Slider') @section('page-title','Edit Hero Slider')
@section('content')<div class="max-w-4xl bg-white rounded-xl shadow p-6"><form method="POST" action="{{ route('admin.sliders.update',$slider) }}" enctype="multipart/form-data">@csrf @method('PUT')
...
<div class="mt-6"><button class="bg-primary text-white px-6 py-2 rounded-lg">Update Slider</button></div></form></div>@endsection
